<%@ Page Title="Permintaan Barang Laboratorium" Language="C#" MasterPageFile="~/Lab.master" AutoEventWireup="true" CodeFile="LabPermintaanBarang.aspx.cs" Inherits="LabPermintaanBarang" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyFooterContainer" Runat="Server">
    <script type="text/javascript">   
        ...
        $("#myButton").on("click", function (e) {
            ...
            $.ajax({
                type: "POST",  
                url: "LabPermintaanBarang.aspx/Permintaan",
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json", // dataType is json format
                success: OnSuccess,
