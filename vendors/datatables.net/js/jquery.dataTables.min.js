...
d[c] = e, "o" === b[1] && X(a[e])
    ...
    var b = m.defaults.oLanguage, c = a.sZeroRecords; !a.sEmptyTable && (c && "Tidak ada data / data tidak ditemukan." === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable"); !a.sLoadingRecords && (c && "Loading..." === b.sLoadingRecords) && E(a, a, "sZeroRecords", "sLoadingRecords");
...
a.iStateDuration ? sessionStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b))
    ...
    oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "Pertama", sLast: "Terakhir", sNext: "Berikutnya", sPrevious: "Sebelumnya" }, sEmptyTable: "Tidak ada data / data tidak ditemukan.", sInfo: "Menampilkan data ke _START_ s/d _END_ dari _TOTAL_ data.",
    sInfoEmpty: "Tidak ada data ditampilkan.", sInfoFiltered: "(filtered from _MAX_ total entries)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Tampilkan _MENU_ data", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "Cari:", sSearchPlaceholder: "ketik untuk mencari", sUrl: "", sZeroRecords: "Tidak ditemukan data yang sesuai."
