<%@ Page Title="Transaksi Barang Keluar" Language="C#" MasterPageFile="~/Lab.master" AutoEventWireup="true" CodeFile="GudangBarangKeluar.aspx.cs" Inherits="GudangBarangKeluar" %>
                ...
                <form id="myForm" class="form-horizontal form-label-left" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="GudangBarangKeluar.aspx" class="btn btn-danger">Batal</a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyFooterContainer" Runat="Server">
    <script type="text/javascript">   
        ...
        $("#myButton").on("click", function (e) {
            ...
            var user = $("#user").val();
            var jsonData = JSON.stringify({ barang: barang, jumlah: jumlah, lab: lab, keterangan: keterangan, user: user });
            $.ajax({
                type: "POST",  
                url: "GudangBarangKeluar.aspx/BarangKeluar",
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json", // dataType is json format
                success: OnSuccess,
            ...
            function OnSuccess(response) {
                if (response.d.Status == true) {
                    new PNotify({
                        title: 'Transaksi Barang Keluar Berhasil',
                ...
                {
                    new PNotify({
                        title: 'Transaksi Barang Keluar Gagal',
                        text: response.d.ErrorMessage,
                        type: 'error',
                        styling: 'bootstrap3'
                    });
